...
/**
 * Cliff's HashMap, which is non-blocking (thread-safe) and fast.
 *
 * @see https://en.wikipedia.org/wiki/Non-blocking_algorithm
 * @see http://www.azulsystems.com/blog/cliff/2007-03-26-non-blocking-hashtable
 */
@SuppressWarnings({"restriction", "rawtypes", "unchecked", "unused"})
public class CHashMap<TypeK, TypeV> extends AbstractMap<TypeK, TypeV> implements
    ConcurrentMap<TypeK, TypeV>, Cloneable, Serializable {
  ...
  static {                      // <clinit>
    Field f = null;
    try { f = CHashMap.class.getDeclaredField("_kvs"); }
  ...
  /** Create a new CHashMap with default minimum size (currently set
   *  to 8 K/V pairs or roughly 84 bytes on a standard 32-bit JVM). */
  public CHashMap( ) { this(MIN_SIZE); }

  /** Create a new CHashMap with initial room for the given number of
  ...
  public CHashMap( final int initial_sz ) { initialize(initial_sz); }
  ...
  public void clear() {         // Smack a new empty table down
    Object[] newkvs = new CHashMap(MIN_SIZE)._kvs;
  ...
  public Object clone() {
    try {
      ...
      CHashMap<TypeK,TypeV> t = (CHashMap<TypeK,TypeV>) super.clone();
  ...
  private static final Object get_impl( final CHashMap topmap, final Object[] kvs, final Object key, final int fullhash ) {
  ...
  private static final Object putIfMatch( final CHashMap topmap, final Object[] kvs, final Object key, final Object putval, final Object expVal ) {
    assert putval != null;
  ...
  // --- CHM -----------------------------------------------------------------
  // The control structure for the CHashMap
  static final class CHM<TypeK,TypeV> {
    ...
    private final Object[] resize( CHashMap topmap, Object[] kvs) {
      assert chm(kvs) == this;
    ...
    // of the top position.
    private final void help_copy_impl( CHashMap topmap, Object[] oldkvs, boolean copy_all ) {
    ...
    // read it yet.
    private final Object[] copy_slot_and_check( CHashMap topmap, Object[] oldkvs, int idx, Object should_help ) {
      assert chm(oldkvs) == this;
      Object[] newkvs = _newkvs; // VOLATILE READ
    ...
    private final void copy_check_and_promote( CHashMap topmap, Object[] oldkvs, int workdone ) {
      assert chm(oldkvs) == this;
    ...
    private boolean copy_slot( CHashMap topmap, int idx, Object[] oldkvs, Object[] newkvs ) {
  ...
  private class SnapshotV implements Iterator<TypeV>, Enumeration<TypeV> {
    ...
    public SnapshotV() {
      while( true ) {           // Verify no table-copy-in-progress
        ...
        topchm.help_copy_impl(CHashMap.this,topkvs,true);
      }
      // Warm-up the iterator
      next();
    }
    int length() { return len(_sskvs); }
    Object key(int idx) { return CHashMap.key(_sskvs,idx); }
    ...
    public void remove() {
      ...
      putIfMatch( CHashMap.this, _sskvs, _prevK, TOMBSTONE, _prevV );
      _prevV = null;
    }
  ...
  public Collection<TypeV> values() {
    return new AbstractCollection<TypeV>() {
      @Override public void    clear   (          ) {        CHashMap.this.clear        ( ); }
      @Override public int     size    (          ) { return CHashMap.this.size         ( ); }
      @Override public boolean contains( Object v ) { return CHashMap.this.containsValue(v); }
  ...
  public Set<TypeK> keySet() {
    return new AbstractSet<TypeK> () {
      @Override public void    clear   (          ) {        CHashMap.this.clear   ( ); }
      @Override public int     size    (          ) { return CHashMap.this.size    ( ); }
      @Override public boolean contains( Object k ) { return CHashMap.this.containsKey(k); }
      @Override public boolean remove  ( Object k ) { return CHashMap.this.remove  (k) != null; }
   ...
   *  iteration.  The {@link CHashMap} does not normally create or
  ...
  public Set<Map.Entry<TypeK,TypeV>> entrySet() {
    return new AbstractSet<Map.Entry<TypeK,TypeV>>() {
      ...
      @Override public boolean remove( final Object o ) {
        ...
        return CHashMap.this.remove(e.getKey(), e.getValue());
      }
  ...
  // Counter
  //
  static class Counter extends ConcurrentAutoTable {

    private static final long serialVersionUID = 9093210551234321055L;
    // ConcurrentAutoTable is sufficient for now
  } // End Counter

  static class ConcurrentAutoTable implements Serializable {

    private static final long serialVersionUID = 1234321055909321055L;
    // --- public interface ---
    ...
    private static class CAT implements Serializable {
      private static final long serialVersionUID = 9093210551248321055L;
  ...
  } // End ConcurrentAutoTable

  static class AbstractEntry<TypeK,TypeV> implements Map.Entry<TypeK,TypeV> {
    /** Strongly typed key */
